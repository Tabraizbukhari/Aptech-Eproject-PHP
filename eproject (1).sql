...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2020 at 09:08 PM
...
(3, 'How to view the image files?', 'If you know the image ID number, you can enter it into the search bar to navigate right to that image. it has built technology that can “see” image pixels and find similar images.', '0', '2020-07-09 17:58:36'),
...
(2, 1, 1, 'Conserve the environment by planting trees.', 'images/photo-1589605711269-3363979a9ca2.jpg', 'Conserve the environment by planting trees. hand protect with plant growing. concept finance environment Earth Day In the hands of trees growing seedlings', 1000, '2020-07-09 17:10:04'),
...
(4, 1, 3, 'value investment thoughts bussiness', 'images/photo-1553729459-efe14ef6055d.jpg', 'Value investing is an investment strategy that involves picking stocks that appear to be trading for less than their intrinsic or book value.', 600, '2020-07-09 17:10:13'),
(5, 1, 3, 'Euro money bag ', 'images/photo-1521828847175-b6d80fc5a7fd.jpg', 'Euro money bag  with the word Fair. Balance. Fair value pricing, money debt. Investment analysis. Fair deal. Reasonable price. Justified risk. Honest loan. Secured loans\r\n', 800, '2020-07-09 17:10:17'),
...
(8, 1, 2, 'Travel Airplane on Sky', 'images/photo-1500835556837-99ac94a94552.jpg', 'This is taken after passing through a severe storm in a plane. This being one of my first flights, I felt lucky to make it out safely and even luckier to capture such a beautiful sunset.', 2000, '2020-07-09 17:10:44'),
(9, 1, 3, 'Business men', 'images/photo-1575473970760-b50a70461e1a.jpg', 'Business men with darkblue suit, vest and red tie', 1000, '2020-07-09 17:10:42'),
...
(12, 1, 3, 'Business on Home', 'images/photo-1523939158338-1708c2391359.jpg', 'FlexJobs. This site offers full-time, part-time, and even some jobs that are perfect for testing your way into starting a freelance business', 7777, '2020-07-09 17:10:30'),
(13, 1, 3, 'Laptop computer glass on table', 'images/photo-1460925895917-afdab827c52f.jpg', 'Business Statistics on a laptop with glass Screen', 2200, '2020-07-09 17:10:28'),
...
(16, 1, 2, 'Eye glass with map', 'images/photo-1516546453174-5e1098a4b4af.jpg', 'my work space. I’m the founder of the company Arttravelling ( travel for artist)', 200, '2020-07-09 17:35:19'),
(18, 1, 2, 'Travel weekend', 'images/photo-1488646953014-85cb44e25828.jpg', 'Planning for the weekend for travelling', 60000, '2020-07-09 17:35:26'),
(19, 2, 2, 'Travel planes', 'images/photo-1496950866446-3253e1470e8e.jpg', 'The Plan before the Adventure', 10, '2020-07-09 17:35:22'),
(20, 2, 2, 'Hamilton Island travel', 'images/photo-1530843119212-2f6e1d57c93a.jpg', 'Taken from the balcony of my hotel in Hamilton Island', 400, '2020-07-09 17:35:58'),
(21, 2, 1, 'woodland path', 'images/photo-1441974231531-c6227db76b6e.jpg', 'Beautiful woodland path in the world', 300, '2020-07-09 17:36:04'),
(22, 2, 1, 'nature leave', 'images/photo-1504198266287-1659872e6590.jpg', 'The beauty of nature in the world', 100, '2020-07-09 17:36:01');
...
(1, 'MuhammadTabraiz', 'Tabraiz', 'bukhari', 'm.tabraizbukhari@gmail.com', '1234567890', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'user', '1', '2020-07-09 16:37:02'),
(2, 'Elsa_jhon', 'Elsa', 'jhon', 'elsa@gmail.com', '1234567890', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'user', '1', '2020-07-09 17:13:38'),
(4, NULL, 'admin', 'admin', 'admin@example.com', '1234567890', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin', '0', '2020-07-09 18:17:45');
