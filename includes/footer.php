		...
		<section id="contact" id="contactus" >
       <div class="container">
           <h3 class="text-center text-uppercase contactushead py-4">contact us</h3>
           <p class="text-center w-75 m-auto">Oren has over a million free high-resolution photos. Explore these popular photo categories on Oren. All photos here are free to download and use under the Oren License.</p>
           <div class="row">
             ...
             <div class="col-sm-12 col-md-6 col-lg-4 my-5">
               <div class="card border-0">
                  <div class="card-body text-center">
                   ...
                   <address>Near Board Office, Aptech NN Center </address>
                  </div>
                </div>
             </div>
             ...
             <div class="col-sm-12 col-md-6 col-lg-4 my-5">
               <div class="card border-0">
                  <div class="card-body text-center">
                    ...
                    <p>info@Oren.Support.com</p>
                  </div>
                </div>
             </div>
		   </div>
		   <div class="bottom-strip">
				<p class="text-center">© CherryDnata  <i class="icon-like"></i> Made in Pakistan</p>
...
<script src="js/vuejsscript.js"></script>
